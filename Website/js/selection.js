var $componentSelection = (function() {
	...
	function selectionPopUp() {
		...
		$content.empty();
		if ($('#pcbuilder-selection .row > div > div.warning').length > 0) {
			$content.append('<h2 class="text-warning"><span class="glyphicon glyphicon-warning-sign"></span> De onderdelen die u heeft geselecteerd zijn mogelijk niet compatibel.</h2>');
		}
