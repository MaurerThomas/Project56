function checkCompatibility($button) {
	var $websocket = check('WebSocket'), $JSON = check('JSON'), $localStorage = check('localStorage');
	...
	return {localStorage: $localStorage, JSON: $JSON, WebSocket: $websocket};
}